...
paths_dict = {
    "pagerank": Path(
        "./data/ego_facebook/facebook/diffusion_icm_facebook_pagerank.csv"
    ),
    "degree": Path("./data/ego_facebook/facebook/diffusion_icm_facebook_degree.csv"),
    "closeness": Path(
        "./data/ego_facebook/facebook/diffusion_icm_facebook_closeness.csv"
    ),
    "betweenness": Path(
        "./data/ego_facebook/facebook/diffusion_icm_facebook_betweenness.csv"
    ),
    "eigenvector": Path(
        "./data/ego_facebook/facebook/diffusion_icm_facebook_eigenvector.csv"
    ),
    "heuristic_greedy": Path(
        "./data/ego_facebook/facebook/diffusion_icm_facebook_influence.csv"
    ),
    "random": Path("./data/ego_facebook/facebook/diffusion_icm_facebook_random.csv"),
}
colors_dict = {
    "pagerank": {
...
fig.update_layout(
    title=dict(text="Diffusion with Independent Cascade Model", font=dict(size=20)),
