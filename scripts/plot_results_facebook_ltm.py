...
paths_dict = {
    "pagerank": Path(
        "./data/ego_facebook/facebook/diffusion_ltm_facebook_pagerank.csv"
    ),
    "degree": Path("./data/ego_facebook/facebook/diffusion_ltm_facebook_degree.csv"),
    "closeness": Path(
        "./data/ego_facebook/facebook/diffusion_ltm_facebook_closeness.csv"
    ),
    "betweenness": Path(
        "./data/ego_facebook/facebook/diffusion_ltm_facebook_betweenness.csv"
    ),
    "eigenvector": Path(
        "./data/ego_facebook/facebook/diffusion_ltm_facebook_eigenvector.csv"
    ),
    "heuristic_greedy": Path(
        "./data/ego_facebook/facebook/diffusion_ltm_facebook_influence.csv"
    ),
    "random": Path("./data/ego_facebook/facebook/diffusion_ltm_facebook_random.csv"),
}
colors_dict = {
    "pagerank": {
