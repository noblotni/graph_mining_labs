...
paths_dict = {
    "pagerank": Path("./data/lastfm_asia/diffusion_icm_lastfm_pagerank.csv"),
    "degree": Path("./data/lastfm_asia/diffusion_icm_lastfm_degree.csv"),
    "closeness": Path("./data/lastfm_asia/diffusion_icm_lastfm_closeness.csv"),
    "betweenness": Path("./data/lastfm_asia/diffusion_icm_lastfm_betweenness.csv"),
    "eigenvector": Path("./data/lastfm_asia/diffusion_icm_lastfm_eigenvector.csv"),
    "heuristic_greedy": Path("./data/lastfm_asia/diffusion_icm_lastfm_influence.csv"),
    "random": Path("./data/lastfm_asia/diffusion_icm_lastfm_random.csv"),
}
colors_dict = {
    "pagerank": {
